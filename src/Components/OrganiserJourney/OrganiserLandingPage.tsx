    ...
    if (reviewingShortlist)
        return (
            <RestaurantFinalList
                ...
                setEventConfirmed={setEventConfirmed}
                restaurantShortlist={restaurantShortlist}
                setRestaurantShortlist={setRestaurantShortlist}
                setReviewingShortlist={setReviewingShortlist}
            />
        );
    if (eventConfirmed)
        return (
